...
dimension T(ni,nj),x(ni),y(nj),f(ni) 
...
!refinamento assimétrico em x
do i=2,l1
	f(i)=(coef_a*((i-2.d0)/(l1-2.d0)))+(1.d0-coef_a)
	x(i)=a*f(i)*(((-0.5d0*dtanh(alp*((2.d0*(i-2.d0)/(l1-2.d0))-1.d0)))/(dtanh(-alp)))+0.5d0)
enddo
